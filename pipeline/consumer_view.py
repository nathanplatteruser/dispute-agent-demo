...
After the pipeline drafts a letter, this module shows what the recipient
actually experiences. Three components:

1. Consumer-view renderer: presents the letter as it would arrive
2. Plain-language diff: agency intent vs. what the letter communicates
3. "What this makes someone do" annotator: flags language that is
   technically compliant but likely to cause disengagement, panic, or
   avoidance. Grounded in CFPB complaint patterns.
"""
