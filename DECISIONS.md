...
| 2026-08-20 | Session is 60 min, not 25 min solo + separate hands-on | Brief specifies 60-minute cooking show format. Built run-of-show to that structure | Splitting into two separate artifacts for two separate sessions |
